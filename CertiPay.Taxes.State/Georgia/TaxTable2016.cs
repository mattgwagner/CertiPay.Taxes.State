    ...
    public class TaxTable2016 : TaxTable
    {
        ...
        public override IEnumerable<TaxableWithholding> TaxableWithholdings
        {
            get
            {
                ...
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Weekly, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 19.00m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Weekly, MiniumWithholding = 0.19m, MinimumWage = 19.00m, MaximumWage = 57.50m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Weekly, MiniumWithholding = 0.96m, MinimumWage = 57.50m, MaximumWage = 96.00m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Weekly, MiniumWithholding = 2.12m, MinimumWage = 96.00m, MaximumWage = 135.00m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Weekly, MiniumWithholding = 3.65m, MinimumWage = 135.00m, MaximumWage = 192.50m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Weekly, MiniumWithholding = 6.54m, MinimumWage = 192.50m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };

                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.BiWeekly, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 38.50m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.BiWeekly, MiniumWithholding = 0.38m, MinimumWage = 38.50m, MaximumWage = 115.00m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.BiWeekly, MiniumWithholding = 1.92m, MinimumWage = 115.00m, MaximumWage = 192.00m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.BiWeekly, MiniumWithholding = 4.23m, MinimumWage = 192.00m, MaximumWage = 269.00m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.BiWeekly, MiniumWithholding = 7.31m, MinimumWage = 269.00m, MaximumWage = 385.00m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.BiWeekly, MiniumWithholding = 13.08m, MinimumWage = 385.00m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };

                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.SemiMonthly, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 41.50m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.SemiMonthly, MiniumWithholding = 0.42m, MinimumWage = 41.50m, MaximumWage = 125.00m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.SemiMonthly, MiniumWithholding = 2.08m, MinimumWage = 125.00m, MaximumWage = 208.00m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.SemiMonthly, MiniumWithholding = 4.58m, MinimumWage = 208.00m, MaximumWage = 292.00m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.SemiMonthly, MiniumWithholding = 7.92m, MinimumWage = 292.00m, MaximumWage = 417.00m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.SemiMonthly, MiniumWithholding = 14.17m, MinimumWage = 417.00m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };

                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Monthly, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 83.00m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Monthly, MiniumWithholding = 0.83m, MinimumWage = 83.00m, MaximumWage = 250.00m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Monthly, MiniumWithholding = 4.17m, MinimumWage = 250.00m, MaximumWage = 417.00m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Monthly, MiniumWithholding = 9.17m, MinimumWage = 417.00m, MaximumWage = 583.00m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Monthly, MiniumWithholding = 15.83m, MinimumWage = 583.00m, MaximumWage = 833.00m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Monthly, MiniumWithholding = 28.33m, MinimumWage = 833.00m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };

                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Quarterly, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 250.00m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Quarterly, MiniumWithholding = 2.50m, MinimumWage = 250.00m, MaximumWage = 750.00m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Quarterly, MiniumWithholding = 12.50m, MinimumWage = 750.00m, MaximumWage = 1250.00m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Quarterly, MiniumWithholding = 27.50m, MinimumWage = 1250.00m, MaximumWage = 1750.00m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Quarterly, MiniumWithholding = 47.50m, MinimumWage = 1750.00m, MaximumWage = 2500.00m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Quarterly, MiniumWithholding = 85.00m, MinimumWage = 2500.00m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };

                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Annually, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 1000.00m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Annually, MiniumWithholding = 10.00m, MinimumWage = 1000.00m, MaximumWage = 3000.00m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Annually, MiniumWithholding = 50.00m, MinimumWage = 3000.00m, MaximumWage = 5000.00m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Annually, MiniumWithholding = 110.00m, MinimumWage = 5000.00m, MaximumWage = 7000.00m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Annually, MiniumWithholding = 190.00m, MinimumWage = 7000.00m, MaximumWage = 10000.00m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Annually, MiniumWithholding = 340.00m, MinimumWage = 10000.00m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };

                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Daily, MiniumWithholding = 0.00m, MinimumWage = 0.00m, MaximumWage = 2.75m, PercentageOverMinimum = .01m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Daily, MiniumWithholding = 0.03m, MinimumWage = 2.75m, MaximumWage = 8.22m, PercentageOverMinimum = .02m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Daily, MiniumWithholding = 0.14m, MinimumWage = 8.22m, MaximumWage = 13.70m, PercentageOverMinimum = .03m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Daily, MiniumWithholding = 0.30m, MinimumWage = 13.70m, MaximumWage = 19.18m, PercentageOverMinimum = .04m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Daily, MiniumWithholding = 0.52m, MinimumWage = 19.18m, MaximumWage = 27.40m, PercentageOverMinimum = .05m, FilingSubStatus = FilingSubStatus.SingleIncome };
                yield return new TaxTable.TaxableWithholding { FilingStatus = FilingStatus.MarriedFilingJoint, Frequency = PayrollFrequency.Daily, MiniumWithholding = 0.93m, MinimumWage = 27.40m, MaximumWage = Decimal.MaxValue, PercentageOverMinimum = .06m, FilingSubStatus = FilingSubStatus.SingleIncome };
