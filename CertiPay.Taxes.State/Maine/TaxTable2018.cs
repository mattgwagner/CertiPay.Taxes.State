    ...
    public class TaxTable2018 : TaxTable
    {
        ...
        public override IEnumerable<StandardDeduction> StandardDeductions
        {
            get
            {
                ...
                yield return new StandardDeduction { FilingStatus = FilingStatus.Married, FloorAmount = 142200.00m, CeilingAmount = 292200.00m, CalcValue = 150000.00m, Amount = 20750.00m };
                yield return new StandardDeduction { FilingStatus = FilingStatus.Married, FloorAmount = 292200.00m, CeilingAmount = decimal.MaxValue, CalcValue = 0.00m, Amount = 0.00m };
            }
        }
        ...
        public override IEnumerable<TaxableWithholding> TaxableWithholdings
        {
            get
            {
                ...
                yield return new TaxableWithholding { FilingStatus = FilingStatus.Single, StartingAmount = 21450.00m, MaximumWage = 50750.00m, TaxBase = 1244.00m, TaxRate = 0.0675m };
