    ...
    public class TaxTable2017 : TaxTable
    {
        ...
        public IEnumerable<TaxTableHeader> Entries
        {
            get
            {
                ...
                yield return new TaxTableHeader { Year = Year, State = StateOrProvince.NV, SUI_Wage_Base = 39500 }; // Nevada
                ...
                yield return new TaxTableHeader { Year = Year, State = StateOrProvince.PA, SUI_Wage_Base = 3750 }; // Penn
